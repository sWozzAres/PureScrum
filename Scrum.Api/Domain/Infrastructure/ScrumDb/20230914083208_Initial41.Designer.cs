...
namespace Scrum.Api.Domain.Infrastructure.ScrumDb
{
    ...
    [Migration("20230914083208_Initial41")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Scrum.Api.Domain.DefinitionOfDone", b =>
                {
                    ...
                    b.ToTable("DefinitionsOfDone", (string)null);

                    b.ToTable(tb => tb.IsTemporal(ttb =>
                            {
                                ttb.UseHistoryTable("DefinitionsOfDoneHistory");
                                ttb
                                    .HasPeriodStart("PeriodStart")
                                    .HasColumnName("PeriodStart");
                                ttb
            ...
            modelBuilder.Entity("SprintBacklogItemDependencies", b =>
                {
                    b.Property<Guid>("ParentId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Scrum.Api.Domain.ProductBacklogItem", b =>
                {
                    ...
                    b.HasOne("Scrum.Api.Domain.Sprint", "Sprint")
                        ...
                        .HasConstraintName("FK_ProductBacklogItems_Sprint_SprintId");
            ...
            modelBuilder.Entity("SprintBacklogItemDependencies", b =>
                {
                    b.HasOne("Scrum.Api.Domain.SprintBacklogItem", "Child")
                        .WithMany()
                        .HasForeignKey("ChildId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Scrum.Api.Domain.SprintBacklogItem", "Parent")
                        .WithMany()
                        .HasForeignKey("ParentId")
                        .OnDelete(DeleteBehavior.ClientCascade)
                        .IsRequired();
